...
// Explicit compatibility barrel for the bj5 app-main/new-thread producer aliases split into semantic runtime modules.
import {
...
export { initDiffPathRuntimeChunk, NULL_DIFF_PATH } from "../utils/parse-diff";
